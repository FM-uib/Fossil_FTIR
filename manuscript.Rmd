...
Fourier Transform Infrares (FTIR) spectroscopy has become a popular method for analysing pollen chemsitry
A number of FTIR studies have identified pollen chemical differences on genus level, which may extent to species level differences. 
...
Further, chemical methods are suitable for automation and offer a more objective method than traditional morphological methods.
In addition to taxonomic differences in pollen chemistry, there is evidence of environmental signals that are recorded in the chemistry of pollen.
...
In some cases the pollen samples are processed with acetolysis following standard palynological methods (Erdman) to simulate fossilization.
