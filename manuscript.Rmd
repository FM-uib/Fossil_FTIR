...
(NEEDS SHORT PARAGRAPH ON NEW MICROSCOPE SETUP. capturing of larger area instead of single grain targeting)
...
PCA ordination shows that the fossil pollen are clearly separated from the fresh pollen, but not clearly separable into three cores (Fig \@ref(fig:pca_acet_sel)).
...
## Differences between acetolysed and SPT pollen
...
```{r echo=FALSE, fig.cap="DAL whole core mean plots", message=FALSE, warning=FALSE, out.width="100%"}
mean_plots = readRDS(here("data","output","mean_plots_whole.rds"))

mean_plots[[1]]
```

```{r echo=FALSE, fig.cap="MFM whole core mean plots", message=FALSE, warning=FALSE, out.width="100%"}
mean_plots[[2]]
```

```{r echo=FALSE, fig.cap="TSK whole core mean plots", message=FALSE, warning=FALSE, out.width="100%"}
mean_plots[[3]]
```
<!--
...
strange peak in SPT samples most likely biogenic silica, when compared to this biogenic silica spectra from diatoms [@alipourInfraredMicrospectroscopyBionanomaterials2016].
