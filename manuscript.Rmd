...
Pollengrains are an important tool to reconstruct past vegetational, environmental and climatic changes. 
EXAMPLES

Palaeo relies on taxonomic identification of pollen based on morphology.
Not always possible.
Recently IR spectro has emerged as a promising candidate to improve taxonomic resolution and automation of pollen counting.

Pollen is preserved in lake sediments and has shown to be resistant to diagenetic processes and found in most palaeoecological records. 
