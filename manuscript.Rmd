...
So far, most FTIR studies focused on identification of pollen have used modern material and bulk measurements, while some used FTIR microscopes.
These FTIR microscopes required manual targeting of small areas of the sample slides to record spectra of single or groups of pollen grains.
...
With these newer machines a larger area is irradiated with FTIR and spectra are recorded at higher resolution over the entire irradiated area.
...
Most common is acetolysis in addition to HF treatment [@erdtmanSixNotesPollen1959; @faegriTextbookPollenAnalysis1989].
These strong acid treatments aim to remove other organic particulates and silicates, while preserving morphological integrity of pollen grains [REF].
A limited number of studies have used acetolysis and other chemical treatments in combination with FTIR on pollen to simulate fossilization [@julierChemotaxonomyToolInterpreting2016; @jardinePollenSporesBiological2016; @woutersenNovelApproachStudy2018] or study the effects of acid extractions [@jardineImpactOxidationSpore2015; @jardineSporopolleninChemistryIts2021].
@jardineImpactOxidationSpore2015 found limited to no effect of short acetolysis (<10 min) on *Lycopodium* spore exine chemistry, while labile outer compounds and the intine/protoplast where removed.
...
Density separation may be a an alternative to acid extractions for pollen studies concerned with chemical alteration of pollen grain chemistry.
SPT is an inorganic compound, which should not alter pollen chemistry in any way and is removed with several washes after extraction.
Contamination of the sample is easily identifiable by characteristic wavebands visible in the spectra. 
...
There are differences between fresh and fossil grains (Fig. \@ref(fig:meanDAL), \@ref(fig:meanMFM) and \@ref(fig:meanTSK).
...
Most notibly the lipid peak at 1745 cm^-1^, caused by triglycerides, is not visible in the fossil pollen grains, neither acetolysed or raw.
There are also several differences in the carbohydrate region from 1000 to 1250 cm^-1^ between fresh and fossil pollen grains.
A peak at 1030  and ~1200 cm^-1^ is visible in the acetolysed pollen but not in the fresh spectra, while we see a broad peak at 1090-1100 cm^-1^ in the SPT spectra of all three cores.
This peak is not present in either fresh pollen or acetolysed pollen, additionally Tiefer See shows a similar peak at 1630.

PCA ordination shows that the fossil pollen are clearly separated from the fresh pollen, but not clearly separable into the three cores (Fig \@ref(fig:pcaacetsel)).
