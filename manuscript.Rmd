...
After visual inspection of the spectra, the chemical differences between modern and fossil polle were explored with a PLSR.
The ordination showed that the fossil pollen are clearly separated from the modern pollen (Fig \@ref(fig:plsrord)).
The regression coefficients reflect our observations from the mean spectra and show high importance of the 1745 lipid peak, the 1500 - 1800 region and the 1170 peak.
