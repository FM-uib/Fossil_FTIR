...
## Extraction of *Pinus* FTIR spectra using the FDA detector
In this study we investigated the use of an FDA detector in combination with a FTIR microscope that allows capture of several spectra in order to characterise the chemistry of pollen grains from a sediment sample.
...
Thus, moving forward we see potential in the application of the FDA detector in chemical palaeoecology. 
