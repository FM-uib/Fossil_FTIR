...
Pollengrains are extracted from sediments, bogs and other deposits and counted.
These pollen records are an important tool to reconstruct past floristic, vegetational and environmental changes. 
EXAMPLES
...
In some cases the pollen samples are processed with acetolysis following standard palynological methods [@erdtmanSixNotesPollen1959; @faegriTextbookPollenAnalysis1989] to simulate fossilization.
