...
# Chemistry of fossil Pinus pollen and the effect of acetolysis
...
Tinner/Cesar cores:
Urio Quattrocchi (supra mediterranean) [@bisculmHoloceneVegetationFire2012]
Sa Curcurica (thermo mediterranean) [@beffaVegetationFireHistory2016]
Lago del Sangiatto (southern alps)
...
- extract fresh Pinus from images
- measure samples from 2 more cores (9 each)
- mark Alnus and BetCor on images
- extract Alnus BetCor from Dal samples
- extract fresh Alnus BetCor
...
Pollengrains are resistant to the diagenetic processes that occur in the formation of sediments, bogs and other deposits, which makes pollen records 
an important tool to reconstruct past floristic, vegetational and environmental changes. 
EXAMPLES
...
ii. effect of orientation and depth/age on chemistry
iii. difference to other species
    -> needs extracting of spectra from files (marking of grains on images)
    -> add another core
