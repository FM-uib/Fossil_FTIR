...
an important tool to reconstruct past vegetational, environmental and climatic changes. 
EXAMPLES
...
The exact structure of sporopollenin is unknown, but recent studies give a more detailed picture of this complex substance [@liMolecularStructurePlant2019]. 


In recent years, the study of pollen grain chemistry has lead to new information on the chemical structure of sporopollenin.
Taxonomic differences have been identified in the chemistry of pollen, as well as environmental information stored in the chemistry of pollen (UV Proxy). 


pollengrains are higly resistant to the processes that occur in the formation of sediments, bogs and other deposits (diagenesis).
Sporopollenin is a biopolymer, which is the main building block for pollen grains. 
Palaeo relies on taxonomic identification of pollen based on morphology.
Not always possible.
Recently IR spectro has emerged as a promising candidate to improve taxonomic resolution and automation ofpollen counting.
EXAMPLES
